Messages_mapping = {'ET DNS Query for .cc TLD [**] [Classification: Potentially Bad Traffic]': None,
 ...
 'ET DROP Spamhaus DROP Listed Traffic Inbound group 39 [**] [Classification: Misc Attack]': 'T1071',
 ...
 'ET JA3 Hash - [Abuse.ch] Possible Adware [**] [Classification: Unknown Traffic]': 'T1071',
 'ET MALWARE Win32/Suspected Reverse Shell Connection [**] [Classification: A Network Trojan was detected]': 'T1059',
 ...
 'ET POLICY curl User-Agent Outbound [**] [Classification: Attempted Information Leak]': 'T1071',
 ...
 'ET SCAN Possible Nmap User-Agent Observed Web Application Attack': 'T1595',
 'ET SCAN Nmap Scripting Engine User-Agent Detected (Nmap Scripting Engine) Web Application Attack': 'T1595',
 'ET SCAN NMAP SIP Version Detect OPTIONS Scan Attempted Information Leak': 'T1595.002',
 'ET SCAN Potential SSH Scan Attempted Information Leak': 'T1595',
 ...
 'ET WEB_SPECIFIC_APPS PHP-CGI query string parameter vulnerability Web Application Attack': 'T1190',
 'ET WEB_SERVER WEB-PHP phpinfo access Information Leak': 'T1592',
 'ET WEB_SERVER Script tag in URI Possible Cross Site Scripting Attempt Web Application Attack': 'T1190',
 ...
 'ET WEB_SPECIFIC_APPS SAPID get_infochannel.inc.php Remote File inclusion Attempt Web Application Attack': 'T1059',
 ...
 'ET WEB_SPECIFIC_APPS BASE base_stat_common.php remote file include Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS phpSkelSite theme parameter remote file inclusion Web Application Attack': 'T1190',
 'ET WEB_SPECIFIC_APPS TECHNOTE shop_this_skin_path Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS phPortal gunaysoft.php sayfaid Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS phPortal gunaysoft.php icerikyolu Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS ProjectButler RFI attempt  Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS MODx CMS snippet.reflect.php reflect_base Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS FormMailer formmailer.admin.inc.php BASE_DIR Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS MAXcms fm_includes_special Parameter Remote File Inclusion Attempt Web Application Attack': 'T1190',
 'ET WEB_SPECIFIC_APPS SERWeb main_prepend.php functionsdir Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Sisplet CMS komentar.php site_path Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS SERWeb load_lang.php configdir Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS OpenX phpAdsNew phpAds_geoPlugin Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Possible eFront database.php Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS p-Table for WordPress wptable-tinymce.php ABSPATH Parameter RFI Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS AjaxPortal di.php pathtoserverdata Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SERVER PHP REQUEST SuperGlobal in URI Potentially Bad Traffic': None,
 'ET WEB_SPECIFIC_APPS PointComma pctemplate.php pcConfig Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS ProdLer prodler.class.php sPath Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS KingCMS menu.php CONFIG Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS YapBB class_yapbbcooker.php cfgIncludeDirectory Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS PHP-Paid4Mail RFI attempt  Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS OBOphiX fonctions_racine.php chemin_lib parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Enthusiast path parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Achievo debugger.php config_atkroot parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS PHPOF DB_AdoDB.Class.PHP PHPOF_INCLUDE_PATH parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Mambo Component com_smf smf.php Remote File Inclusion Attempt Web Application Attack': 'T1059',
 "ET WEB_SPECIFIC_APPS Possible Mambo/Joomla! com_koesubmit Component 'koesubmit.php' Remote File Inclusion Attempt Web Application Attack": 'T1059',
 'ET WEB_SPECIFIC_APPS Joomla AjaxChat Component ajcuser.php GLOBALS Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SERVER PHP ENV SuperGlobal in URI Potentially Bad Traffic': None,
 'ET WEB_SPECIFIC_APPS phptraverse mp3_id.php GLOBALS Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS PHP phpMyAgenda rootagenda Remote File Include Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Joomla swMenuPro ImageManager.php Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Joomla Simple RSS Reader admin.rssreader.php mosConfig_live_site Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Joomla Onguma Time Sheet Component onguma.class.php mosConfig_absolute_path Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Joomla Dada Mail Manager Component config.dadamail.php GLOBALS Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Golem Gaming Portal root_path Parameter Remote File inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS KR-Web krgourl.php DOCUMENT_ROOT Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS Possible OpenSiteAdmin pageHeader.php Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS PHP Classifieds class.phpmailer.php lang_path Parameter Remote File Inclusion Attempt Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS DesktopOnNet frontpage.php app_path Parameter Remote File Inclusion Web Application Attack': 'T1059',
 'ET WEB_SPECIFIC_APPS DesktopOnNet don3_requiem.php app_path Parameter Remote File Inclusion Web Application Attack': 'T1059',
 ...
 'ET WEB_SERVER /system32/ in Uri - Possible Protected Directory Access Attempt Attempted Information Leak': 'T1083',
 'ET WEB_SERVER cmd.exe In URI - Possible Command Execution Attempt Attempted Information Leak': 'T1059',
 'GPL WEB_SERVER viewcode access Web Application Attack': 'T1190',
 'GPL EXPLOIT unicode directory traversal attempt Web Application Attack': 'T1083',
 'GPL EXPLOIT fpcount access access to a potentially vulnerable web application': 'T1190',
 'ET WEB_SERVER ColdFusion administrator access Web Application Attack': 'T1078',
 ...
 'ET WEB_SERVER SELECT USER SQL Injection Attempt in URI Web Application Attack': 'T1190',
 ...
 'GPL WEB_SERVER .htaccess access Attempted Information Leak': 'T1083',
 'GPL WEB_SERVER .htpasswd access Web Application Attack': 'T1083',
 ...
 'GPL EXPLOIT iisadmpwd attempt Web Application Attack': 'T1190',
 ...
 'ET WEB_SERVER MYSQL SELECT CONCAT SQL Injection Attempt Web Application Attack': 'T1190',
 ...
 'GPL WEB_SERVER /~root access Attempted Information Leak': 'T1005',
 'ET WEB_SERVER Possible CVE-2014-6271 Attempt Attempted Administrator Privilege Gain': 'T1548',
 'ET WEB_SERVER Possible CVE-2014-6271 Attempt in Headers Attempted Administrator Privilege Gain': 'T1548',
 'ET CURRENT_EVENTS QNAP Shellshock CVE-2014-6271 Attempted Administrator Privilege Gain': 'T1548',
 'ET POLICY Proxy TRACE Request - inbound Potentially Bad Traffic': None,
 'ET SCAN Nikto Web App Scan in Progress Web Application Attack': 'T1595.002',
 'ET WEB_SERVER Possible Cherokee Web Server GET AUX Request Denial Of Service Attempt Attempted Denial of Service': 'T1499.002',
 ...
 'ETPRO ATTACK_RESPONSE MongoDB Version Request Successful Administrator Privilege Gain': 'T1548',
 'ETPRO ATTACK_RESPONSE MongoDB Database Enumeration Request Successful Administrator Privilege Gain': 'T1548',
 'ET WEB_SERVER /bin/bash In URI Possible Shell Command Execution Attempt Within Web Exploit Web Application Attack': 'T1059',
 'ET ATTACK_RESPONSE Output of id command from HTTP server Potentially Bad Traffic': None,
 ...
 'ET SCAN Sqlmap SQL Injection Scan Attempted Information Leak': 'T1595.002',
 'ETPRO WEB_SERVER SQLMap Scan Tool User Agent Web Application Attack': 'T1595.002',
 ...
 'ET SCAN NMAP OS Detection Probe Attempted Information Leak': 'T1595',
 ...
 'ETPRO SCAN IPMI Get Authentication Request (null seq number - null sessionID) A Network Trojan was detected': 'T1046',
 'GPL RPC xdmcp info query Attempted Information Leak': None,
 'ET INFO Executable Download from dotted-quad Host A Network Trojan was detected': 'T1105',
 ...
 'ET WEB_SERVER Suspicious Chmod Usage in URI Attempted Administrator Privilege Gain': 'T1068',
 'ET POLICY Executable and linking format (ELF) file download Potential Corporate Privacy Violation': 'T1105',
 'ET SCAN Grendel-Scan Web Application Security Scan Detected Attempted Information Leak': 'T1595',
 'ET TROJAN Backdoor family PCRat/Gh0st CnC traffic (OUTBOUND) 106 A Network Trojan was detected': 'T1071'}
...
with open('Dev/Data/MergedData.csv', 'r') as file:
    data = file.readlines()
    file.close()

uniques = {}
for line in data:
    # for each machine fill the dictionary with the corresponding data
    # the key is the machine name
    # the value is a list of events
    machine = line.split(',')[2]
    if machine not in uniques:
        uniques[machine] = []
    uniques[machine].append(line)

# in the dictionary find the machine with the most events
max_events = 0
max_machine = ""
for key, value in uniques.items():
    if len(value) > max_events:
        max_events = len(value)
        max_machine = key

print(max_machine, max_events)
